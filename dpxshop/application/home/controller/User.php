...
/**/
    ...
    public function receiveConfirm(){
       ...
       public function tudi_message(){
       return $this->fetch('user/tudi_message');
    }
    public function farm_message(){
       return $this->fetch('user/farm_message');
    }
     public function connect(){
       return $this->fetch('user/connect');
    } 
